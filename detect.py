#python3 detect.py --names data_firev6/yolo.names --cfg data_firev6/yolov3-tiny.cfg --source data_firev6/fire2.mp4
import argparse
...
if __name__ == '__main__':
    ...
    parser.add_argument('--names', type=str, default='data_firev6/yolo.names', help='*.names path')
