#python3 normal_prune.py --cfg data_firev6/yolov3-tiny.cfg --data data_firev6/yolo.data --weights weights/best.pt
from models import *
...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', type=str, default='weights/DM_darknet.pt', help='sparse model weights')
    parser.add_argument('--percent', type=float, default=0.93, help='global channel prune percent')
    ...
    for item in compact_module_defs:
        if item['type'] == 'shortcut':
            ...
            item['anchors'] = anchor
    print("Attempting to write to:", pruned_cfg_name)  # Debugging print
    ...
    compact_model_name = opt.weights.replace( opt.weights.split('/')[-1], f'normal_prune_{str(percent)}_percent.weights')
