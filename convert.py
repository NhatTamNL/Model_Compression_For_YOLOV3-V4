#python3 detect.py --names data_firev6/yolo.names --source data_firev6/fire2.mp4
import argparse
import struct
...
if __name__ == '__main__':
    ...
    parser.add_argument('--cfg', type=str, default='data_firev6/normal_prune_0.3_yolov3-tiny.cfg', help='cfg file path')
    parser.add_argument('--data', type=str, default='data_firev6/yolo.data', help='coco.data file path')
