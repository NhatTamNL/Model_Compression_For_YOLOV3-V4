...
def test(cfg,
    ...
    if model is None:
        ...
        # Initialize model
        model = Darknet(cfg, imgsz, quantized=quantized, a_bit=a_bit, w_bit=w_bit, BN_Fold=BN_Fold, FPGA=FPGA)
    ...
    # print(iouv.view, iouv ,"1----\n")
    iouv = iouv[0].view(1)  # comment for mAP@0.5:0.95
    # print(iouv.view, iouv, "2----\n")
    niou = iouv.numel()
    #print( niou, "3----\n")
...
python test.py --cfg  cfg/yolov4tiny/yolov4-tiny_coco.cfg   --data data/coco.data --weights  weights/Dec16_v4_tiny/coco/0_noraml_map36.weights --img-size 416

python test.py --cfg   cfg/yolov4/yolov4-coco.cfg  --data data/coco.data --weights weights/Lab_compression_dec19/coco/yolov4/0_normal_train/normal_train_map63.weights  --img-size 416 --batch-size 1
