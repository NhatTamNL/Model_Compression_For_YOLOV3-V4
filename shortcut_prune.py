...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', type=str, default='weights/v4_tiny_416_map61.pt', help='sparse model weights')
    ...
    compact_model_name = opt.weights.replace(opt.weights.split('/')[-1],  f'shortcut_prune_{str(percent)}_percent.weights')
